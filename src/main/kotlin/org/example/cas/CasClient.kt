...
object CasClient {
    ...
    val CAS_URL_SUFFIX = "/v1/tickets"
    val SERVICE_URL_SUFFIX = "/j_spring_cas_security_check"

    fun getTicket(server: String, username: String, password: String, service: String): String {
        return getServiceTicket(server + CAS_URL_SUFFIX, username, password, service + SERVICE_URL_SUFFIX)
    }
